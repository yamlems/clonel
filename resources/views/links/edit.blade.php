                ...
                <div class="flex flex-col sm:justify-center items-center p-6 bg-white border-b border-gray-200">
                    ...
                    <form method="POST" action="{{ route('links.update', ['link' => $link->id]) }}">
                        ...
                        <div>
                            ...
                            <x-input id="name" class="block mt-1 w-full" type="text" name="name" :value="$link->name" placeholder="My Github Link" required autofocus />
                            @error('name')
                        ...
                        <div class="mt-4">
                            ...
                            <x-input id="body" class="block mt-1 w-full" type="url" name="body" :value="$link->body" placeholder="https://github.com/yamlems" required autofocus />
                            @error('body')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
